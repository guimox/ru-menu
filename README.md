...
Right now, the system has **5427 daily active users** who receive the menu every day. Below, you can access each channel to see how everything works from the user's perspective.
